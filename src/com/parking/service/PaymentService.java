...
public class PaymentService {
    ...
    public Payment processPayment(ServletContext ctx, String transactionId, String userId, double amount, String method) {
        String now = LocalDateTime.now().format(FMT);
        Payment p = new Payment(
                FileHandler.generateId("P"), transactionId, userId, amount, now, method, "PAID"
        );
